...
inline ds::String logLevelToStr(const LogLevel level)
{
    switch (level)
    {
    case LogLevel::DEBUG:
        return ds::String("DEBUG");
    case LogLevel::INFO:
        return ds::String("INFO");
    case LogLevel::WARNING:
        return ds::String("WARNING");
    case LogLevel::ERROR:
        return ds::String("ERROR");
    case LogLevel::FATAL:
        return ds::String("FATAL");
    default:
...
{
  public:
    explicit FileOutput(const ds::String& filename)
    {
...
{
  public:
    const ds::String ConsoleOutputName = ds::String("console");
    ...
    void addOutput(const ds::String& fileName)
    {
        if (fileName == ConsoleOutputName)
        {
            _outputs.emplaceBack(new ConsoleOutput());
        }
        else
        {
            _outputs.emplaceBack(new FileOutput(fileName));
        }
    }
