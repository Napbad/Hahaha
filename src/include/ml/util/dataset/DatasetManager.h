...
public:
     ...
     */
    static Res<std::shared_ptr<DataLoader<float>>, DatasetManagerError>
    getDataset(const ds::Str &name, DatasetSource source = DatasetSource::SKLEARN, size_t batchSize = 32,
               bool shuffle = true);
     ...
     */
    static Res<std::shared_ptr<DataLoader<float>>, DatasetManagerError>
    getDatasetWithConfig(const ds::Str &name, const DatasetConfig &config,
                         DatasetSource source = DatasetSource::SKLEARN, size_t batchSize = 32, bool shuffle = true);
  ...
  const std::unordered_map<ds::Str, DatasetConfig> DatasetManager::_datasetConfigs = {
          {ds::Str("boston_house"),
           DatasetConfig{
                   ...
                   true, // has header
                   ',', // delimiter
                   ds::Str("https://raw.githubusercontent.com/scikit-learn/scikit-learn/main/sklearn/datasets/data/"
          ...
          {ds::Str("diabetes"), DatasetConfig{
                                        ...
                                        false, // no header
                                        ',', // delimiter
                                        ds::Str("https://raw.githubusercontent.com/scikit-learn/scikit-learn/main/"
